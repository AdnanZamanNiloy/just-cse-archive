"""The Singleton Pattern is a creational design pattern that ensures only one object (instance)
 of a class can exist throughout the program and provides a global access point to that instance."""
...
# Factory Pattern(main job is to create objects of different classes)
...
def main():
    ...
    employees[0] = factory.get_teacher("PhD")
    employees[1] = factory.get_teacher("MSc")
