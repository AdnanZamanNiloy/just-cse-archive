...
class Helpsupport:
    def __init__(self, root):
        ...
        # first header image  
        img = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\banner1.jpg")
        ...
        # background image 
        bg1 = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\synthetic-data-scaled.jpg")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\web.png")
        ...
        det_img_btn = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\fb.png")
        ...
        att_img_btn = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\yt-removebg-preview.png")
        ...
        hlp_img_btn = Image.open(r"F:\Desktop\Face Recognation Project\Face_Recog_Images\hlp.jpg")
